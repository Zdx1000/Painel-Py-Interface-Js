...
class VeiculoCarregamentoC3(Base):
    __tablename__ = "veiculos_carregamento_c3"
    ...
    def __repr__(self) -> str:  # pragma: no cover
        return f"<VeiculoCarregamentoC3 id={self.id} metrica_id={self.metrica_id} veiculo={self.veiculo!r} porcentagem={self.porcentagem}>"
